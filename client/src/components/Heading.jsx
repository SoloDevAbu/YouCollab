...
import collaborationImage from '../assets/homeimage.jpg'
  ...
  return (
    <div className='flex text-center pt-20 px-6 md:px-20 gap-6'>
        ...
        <div className='flex flex-col gap-5 w-full md:w-1/2 justify-center px-5'>
            <h1 className='text-3xl font-sans font-bold text-start md:text-5xl'>A collaboration Platform for Youtubers and Editors. <span className='text-red-500'>Save extra effort to upload your videos on YouTube.</span></h1>
